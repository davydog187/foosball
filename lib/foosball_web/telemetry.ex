defmodule FoosballWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      summary("foosball.repo.query.query_time", unit: {:native, :millisecond}),
      summary("foosball.repo.query.queue_time", unit: {:native, :millisecond}),
      summary("foosball.repo.query.idle_time", unit: {:native, :millisecond}),
